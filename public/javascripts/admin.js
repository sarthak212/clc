...
$(document).ready(function (){
        ...
        if(!e.isDefaultPrevented()){
            ...
            $.ajax({
                ...
                data: {
                    ...
                    vendorAadhar:$('#vendorAadhar').val(),
                    vendorPhone: $('#vendorPhone').val(),
                    vendorPassword: $('#vendorPassword').val()
                }
            })
            .done(function(msg){
        ...
        if(!e.isDefaultPrevented()){
            ...
            $.ajax({
                ...
                data: {
                    ...
                    userName: $('#vendorName').val(),
                    userEmail: $('#vendorEmail').val(),
                    userAadhar: $('#vendorAadhar').val(),
                    userPhone: $('#vendorPhone').val(),
    ...
    $(document).on('click', '#settings-categories-new', function(e){
        ...
        $.ajax({
            method: 'POST',
            url: '/admin/settings/vehicle/new',
            data: {
    ...
    $(document).on('click', '#settings-service-new', function(e){
        e.preventDefault();
        $.ajax({
            method: 'POST',
            url: '/admin/settings/service/new',
            data: {
                servicetype: $('#servicetype').val(),
                newNavService: $('#newNavService').val(),
            }
        })
        .done(function(msg){
            showNotification(msg.message, 'success', true);
    ...
    $(document).on('click', '#settings-vehicle-update', function(e){
        e.preventDefault();
        var id = $(this).attr('data-id');
        var formData = new FormData($('#uploadForm1')[0]);
        formData.append('categoryId',id);
        formData.append('submenuValue',$('#navsubmenuvalue').val());
        formData.append('vehicletype',$('#vehicletype').val());
        console.log("Something Called");
        $.ajax({
            method: 'POST',
            url: '/admin/settings/vehicle/update',
            processData: false,
            contentType: false,
            cache: false,
            data: formData
    ...
    $(document).on('click', '.deletecategory', function(e){
        ...
        $.ajax({
            method: 'POST',
            url: '/admin/settings/vehicle/delete',
            data: {
                categoryId : id
            }
        })
    ...
    $(document).on('click', '.deleteservicecentre', function(e){
        e.preventDefault();
        var id = $(this).attr('data-id');
        $.ajax({
            method: 'POST',
            url: '/admin/settings/service/delete',
            data: {
                serviceId : id
            }
        })
    ...
    $(document).on('click', '.deletesubmenu', function(e){
        ...
        $.ajax({
            method: 'POST',
            url: '/admin/settings/vehicle/deletesubmenu',
            data: {
                categoryId : id,
                subName: value
            }
    ...
    $(document).on('click', '#changeCategoryname', function(e){
        ...
        $.ajax({
            method: 'POST',
            url: '/admin/settings/vehicle/changename',
            data: {
                categoryId : id,
                newName: value
            }
    ...
    $(document).on('click', '.VendorSelected', function(e){
        e.preventDefault();
        
        if(confirm('Are you sure?')){
            $.ajax({
                method: 'POST',
                url: '/admin/VendorSelected',
                data: {
                    vendorId: $(this).attr('data-id'),
                    orderId:$('#orderId').val()
                }
    ...
    $(document).on('click', '#uploadvehicle', function(e){
        e.preventDefault();
        var formData = new FormData($('#uploadForm1')[0]);
        formData.append('productId', $('#productId').val());
